\chapter{Thiết kế Mạch nguyên lý và PCB Layout (Schematic and PCB Layout Design)}
    \section{Thiết kế Mạch nguyên lý (Schematic Design)}
        ...
        \subsection{Thiết kế Mạch I\textsuperscript{2}C Buffer}   
            Để bảo đảm tính toàn vẹn dữ liệu khi giao tiếp với nhiều thiết bị ngoại vi qua dây dẫn dài, thiết kế tích hợp IC đệm làm giải pháp phân tách bus chủ động. Lựa chọn này là kỹ thuật cần thiết để hệ thống vận hành ổn định ở chế độ Fast-mode (400\,kHz) mà không bị ảnh hưởng bởi giới hạn điện dung ký sinh 400pF. Việc sử dụng IC đệm giúp cô lập tải chỉ còn 10pF cho bus chính, đồng thời duy trì khả năng truyền dẫn tin cậy cho các nhánh mở rộng, giảm thiểu rủi ro lỗi bit do nhiễu và suy hao tín hiệu.
            \begin{figure}[H]
                \centering
        ...
        \subsection{Thiết kế Mạch Module Adapter}\label{par:sche_wanlan_adapter}
            ...
            Trong phiên bản hiện tại, Module Adapter WAN được triển khai thành hai mạch riêng biệt, bao gồm mạch adapter WAN LTE và mạch adapter WAN Ethernet. Adapter WAN LTE được thiết kế cho mô-đun SIM7600G-H-PCIE và adapter WAN Ethernet. Mỗi adapter đều tích hợp các khối chức năng cần thiết để giao tiếp với baseboard, bao gồm khối cấp và điều khiển nguồn, bộ mở rộng ngõ vào/ngõ ra (IO expander), cùng các bus giao tiếp phần cứng tương ứng. 
            ...
            \begin{itemize}
                \item Mô-đun Zigbee E180-ZG120B (dựa trên SoC Silicon Labs EFR32MG1B) của EBYTE, sử dụng nguồn cấp 3.3V và giao tiếp UART;
                \item Mô-đun LoRaWAN Wio-E5-LE mini (mã 113991156, dựa trên SoC STM32WLE5JC, hỗ trợ băng tần 868\,MHz và 915\,MHz) của Seeed Studio, sử dụng nguồn cấp 3.3V và giao tiếp UART;
            ...
            \begin{longtable}{|c|c|c|}
                ...
                \hline
                \textbf{Loại} & \textbf{Mô-đun} & \textbf{Device ID (4-bit)} \\
                \hline
                \endfirsthead
