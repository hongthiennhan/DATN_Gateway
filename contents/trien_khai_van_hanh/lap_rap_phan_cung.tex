...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/DATN/Assembly_Diagram_Top.png}
    \caption{Top Assembly Diagram }
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/DATN/Assembly_Diagram_Bottom.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{figures/wan_adapter_3d.png}
    \includegraphics[width=0.3\textwidth]{figures/lan_adapter_lora.png}
    \includegraphics[width=0.3\textwidth]{figures/lan_adapter_zigbee.png}
    \includegraphics[width=0.3\textwidth]{figures/lan_adapter_rs485.png}
    \includegraphics[width=0.3\textwidth]{figures/lan_adapter_can.png}
    \includegraphics[width=0.3\textwidth]{figures/lan_adapter_stm32.png}
