\section{Khảo sát và Thử nghiệm}
    ...
    \subsection{Khảo sát các mô hình kiến trúc Gateway IoT phổ biến}
        ...
        Từ khảo sát trên có thể thấy: để đạt được yêu cầu đa giao thức + ổn định + tiết kiệm chi phí, cần một kiến trúc phân vai rõ ràng theo miền chức năng. Đây là cơ sở để đồ án chọn kiến trúc Dual-MCU Master–Slave:
        \begin{itemize}
