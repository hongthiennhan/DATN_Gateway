        ...
        \subsubsection{Thiết kế Layout (Layout Design)}
            ...
            Để đảm bảo thiết bị hoạt động ổn định trong môi trường công nghiệp và tuân thủ các tiêu chuẩn về tương thích điện từ (EMC), thiết kế PCB áp dụng các kỹ thuật layout sau:
                ...
                \begin{enumerate}
                    ...
                    \begin{figure}[h]
                        \centering
                        \includegraphics[width=0.2\textwidth]{figures/crysal_shielding_2D.png}
                        \includegraphics[width=0.2\textwidth]{figures/crysal_shielding_3D.png}
                    ...
                    \begin{figure}[h]
                        \centering
                        \includegraphics[width=0.75\textwidth]{figures/USB_shielding_2D.png}
                    ...
                    \begin{figure}[h]
                        \centering
                        \includegraphics[width=0.3\textwidth]{figures/incorrect_plane_void_routing.png}
                        \includegraphics[width=0.3\textwidth]{figures/slave_i2c0.png}
