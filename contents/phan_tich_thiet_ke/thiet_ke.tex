    ...
    \subsection{Firmware và Software}
        ...
        \begin{enumerate}
            ...
            \begin{longtable}{|p{3.2cm}|p{2.3cm}|p{2.7cm}|p{1.4cm}|p{4.2cm}|}
                ...
                Zigbee & $250\,kbps$ & $\approx 8,2\,kbps$ & $3,2\%$ & Cơ chế CSMA/CA \& Overhead chuẩn ZCL \\ \hline
                ...
                BLE (bật DLE) & $1000\,kbps$ & $\approx 97,6\,kbps$ & $9,7\%$ & $CI = 20\,ms$ \\ \hline
            \end{longtable}
            ...
            \begin{itemize}
                ...
                \item \textbf{Độ trễ UART $T_{UART}$:} Khoảng $10,5\,ms/gói$ với Zigbee, $\approx 15\,ms$ với LoRa AT command.
                \item \textbf{Độ trễ gom gói $T_{batch}$:} Cố định $\approx 50\,ms$ do cơ chế batch flush tại LAN-MCU -- thành phần tốn thời gian nhất với Zigbee và BLE.
                \item \textbf{Độ trễ SPI $T_{SPI}$:} Truyền 1 KB mất $\approx 0,204\,ms$ tại xung nhịp $40\,MHz$.
            \end{itemize}
            ...
            \begin{longtable}{|p{4.5cm}|p{4cm}|p{5.5cm}|}
                ...
                Zigbee $\rightarrow$ MQTT & $10\,ms$--$60\,ms$ & Gom gói ($T_{batch}$) \\ \hline
                LoRa SF7 (P2P) $\rightarrow$ MQTT & $100\,ms$--$150\,ms$ & Thời gian truyền sóng ($T_{air}$) \\ \hline
                BLE $\rightarrow$ MQTT & $4\,ms$--$55\,ms$ & Gom gói ($T_{batch}$) \\ \hline
            \end{longtable}
