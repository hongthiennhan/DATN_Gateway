    ...
    \subsection{Thiết kế phần cứng PCB (PCB Hardware Design)}
            ...
            Sơ đồ khối phần cứng của hệ thống được xây dựng nhằm mô tả tổng thể kiến trúc và mối liên hệ giữa các khối chức năng chính, bao gồm khối xử lý trung tâm, các khối ngoại vi và hệ thống cấp nguồn. Mục tiêu của thiết kế sơ đồ khối là đảm bảo tính rõ ràng, dễ hiểu và khả năng mở rộng trong tương lai. 
                ...
                \paragraph{Sơ đồ khối nguồn:} \par
                    ...
                    \begin{itemize}
                        ...
                        \item \textbf{Bảo vệ quá áp (OVx):} Ngắt kênh đầu vào khi điện áp vượt ngưỡng an toàn do người dùng thiết lập;
                ...
                \paragraph{Sơ đồ khối mạch adapter:} \par
                    ...
                    Mạch adapter được thiết kế nhằm chuẩn hóa giao diện kết nối giữa baseboard và các module mạng phổ biến trên thị trường. Adapter board được kết nối với baseboard thông qua đầu nối chuẩn PCIe 36 chân, trong đó các đường tín hiệu và nguồn được quy hoạch theo một chuẩn riêng thống nhất, hỗ trợ các giao thức cơ bản như USB, UART, SPI và I\textsuperscript{2}C.
        ...
        \subsubsection{Thiết kế Mạch nguyên lý (Schematic Design)}
            ...
            \paragraph{Thiết kế Mạch nguồn}
                ...
                Để tối ưu hóa thiết kế, Texas Instruments cung cấp công cụ tính toán và hướng dẫn cấu hình cho IC TPS2121RUXR (\href{https://www.ti.com/tool/download/PMUX-SWITCHOVER-CALC}{PMUX Switch-over Calculator}). Dựa trên công cụ này, các thông số được lựa chọn trong hệ thống như sau:
                ...
                Dựa trên kết quả tính toán, cuộn cảm MDA5030-1R0M được lựa chọn với dòng bão hòa điển hình $I_{SAT\_typ} = 8.5A$. Ngoài ra, nhằm đảm bảo biên độ dự phòng, cuộn cảm được lựa chọn với dòng bão hòa lớn hơn khoảng $I_{SAT\_req}/0.7$, qua đó bù trừ sai số linh kiện và các điều kiện vận hành thực tế. Cách lựa chọn này góp phần đảm bảo khối nguồn của IC sạc hoạt động ổn định và an toàn.
            ...
            \paragraph{Thiết kế Mạch USB/UART Switch}
                ...
                IC analog switch cho phép chuyển mạch tín hiệu USB giữa hai khối chức năng khác nhau. Trong cấu hình mặc định, đường USB từ SoC ESP32-S3 (slave) được kết nối tới đầu nối LAN1 thông qua PCIe connector. Ngoài ra, IC này có thể được sử dụng để chuyển mạch cho giao tiếp UART khi cần thiết.
