\section{Thiết kế}
    ...
    \subsection{Hardware}
        ...
        \subsubsection{Thiết kế Mạch xử lý trung tâm}
        \subsubsection{Thiết kế Mạch nguồn}
        \subsubsection{Thiết kế Mạch USB}
        \subsubsection{Thiết kế Mạch IO Expander}
        \subsubsection{Thiết kế Mạch RTC}
        \subsubsection{Thiết kế Mạch Micro SD Card}
        \subsubsection{Thiết kế Mạch Module Adapter}
        \subsubsection{Các tiêu chuẩn thiết kế}
        \dots
