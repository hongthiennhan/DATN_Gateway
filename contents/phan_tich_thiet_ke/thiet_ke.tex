    ...
    \subsection{Kiến trúc Hệ thống}
        ...
        \subsubsection{Xử lý dữ liệu}
            ...
            \paragraph{Cơ chế giao tiếp LAN-MCU $\leftrightarrow$ WAN-MCU qua SPI (đảm bảo tin cậy)}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.65\textwidth]{figures/sequencediagram_LAN-MCU-WAN-MCU_SPI.png}
            ...
            \paragraph{Cơ chế cập nhật cấu hình cho Gateway từ App Config PC}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.5\textwidth]{figures/sequence_diagram_App-PC_update.png}
