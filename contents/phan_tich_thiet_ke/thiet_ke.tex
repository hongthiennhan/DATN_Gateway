...
\subsubsection{Thiết kế PCB}
            ...
            \paragraph{Kỹ thuật Layout Hệ thống Nguồn và PDN (Power Supply \& PDN Design):}
                ...
                \begin{enumerate}
                    ...
                    \begin{itemize}
                        \item \textbf{Kết nối Kelvin:} Đường tín hiệu hồi tiếp (Feedback trace) được lấy mẫu (sense) trực tiếp tại điểm sau tụ đầu ra $C_{OUT}$ để đảm bảo điện áp đo được là chính xác nhất.
