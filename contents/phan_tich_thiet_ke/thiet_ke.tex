    ...
    \subsection{Thiết kế phần cứng PCB (PCB Hardware Design)}
            ...
            Sơ đồ khối phần cứng của hệ thống được xây dựng nhằm mô tả tổng thể kiến trúc và mối liên hệ giữa các khối chức năng chính, bao gồm khối xử lý trung tâm, các khối ngoại vi và hệ thống cấp nguồn. Mục tiêu của thiết kế sơ đồ khối là đảm bảo tính rõ ràng, dễ hiểu và khả năng mở rộng trong tương lai. 
                ...
                \paragraph{Sơ đồ khối hệ thống phần cứng:} 
                    ...
                    \begin{itemize}
                        ...
                        \item \textbf{Quản lý thời gian thực (RTC):} Hệ thống tích hợp IC RTC PCF85263ATL, được cấp nguồn dự phòng bằng pin CR2032 (3.0\,V), cho phép duy trì thông tin thời gian ngay khi nguồn cấp chính của hệ thống bị mất.
                ...
                \paragraph{Sơ đồ khối nguồn:} \par
                    ...
                    \begin{itemize}
                        ...
                        \item \textbf{+5V0:} Là rail nguồn rẽ nhánh từ +5V0\_SYS thông qua eFuse, dùng để cấp cho các khối chức năng và module sử dụng điện áp 5\,V. Việc bật/tắt rail nguồn này được điều khiển bởi MCU Master.
                        
                        \item \textbf{+3V3:} Được tạo trực tiếp từ nguồn DC 12\,V, cung cấp cho phần lớn các khối chức năng của hệ thống, bao gồm module LAN/WAN, mạch logic điều khiển và các ngoại vi. Rail nguồn này cũng được quản lý bởi MCU Master.
        ...
        \subsubsection{Thiết kế Mạch nguyên lý (Schematic Design)}
            ...
            \paragraph{Thiết kế Mạch xử lý trung tâm}
                ...
                Giá trị điện dung ký sinh rất nhỏ (0.3\,pF) giúp đảm bảo tín hiệu dữ liệu USB duy trì tốc độ truyền chuẩn Full-Speed 12\,Mbit/s, giảm thiểu suy hao biên độ hay méo dạng sóng.
