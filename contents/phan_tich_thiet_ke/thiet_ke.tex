    ...
    \subsection{Thiết kế phần cứng PCB (PCB Hardware Design)}
        ...
        \subsubsection{Phân tích và Mô phỏng Tín hiệu (Signal Integrity Simulation)}
            ...
            \paragraph{Phân tích và Mô phỏng Mạng phân phối nguồn (Power Distribution Network - PDN)}
                ...
                \item \textbf{Phân tích và Mô phỏng Mật độ dòng điện và Sụt áp DC:}
                    
                    Mục tiêu của quá trình mô phỏng là xác minh tính toàn vẹn của mạng phân phối nguồn (PDN) dưới điều kiện tải cực đoan (Worst-case scenario) và điều kiện tải bình thường. Mật độ dòng điện quá lớn có thể gây hư hỏng mạch và sụt áp quá nhiều sẽ dẫn đến hiệu suất kém hoặc thậm chí không hoạt động. Do đó, việc phân tích kỹ lưỡng các ray nguồn chính là rất quan trọng để đảm bảo thiết kế đáp ứng các tiêu chí kỹ thuật đã đề ra.

                    Mật độ dòng điện ảnh hưởng đến khả năng tải dòng và mức tăng nhiệt độ theo công thức $I = k\Delta T^{0.44}A^{0.725}$, trong đó $k$ là hằng số thay đổi theo vị trí dây dẫn, $k = 0.048$ cho lớp ngoài và $k = 0.024$ cho lớp trong.
                    ...
                    \begin{itemize}
                        ...
                        \item Điện áp tại cuối tải phải duy trì trên mức tối thiểu cần thiết để đảm bảo hoạt động ổn định của các linh kiện.
                        \item Điện trở đường dẫn phải được tối thiểu hóa, nhỏ hơn $50m\Omega$ trong điều kiện tải cực đoan.
                        \item Mật độ dòng điện không vượt quá $100A/mm^2$ để tránh quá nhiệt và hư hỏng vật lý trên đường mạch.
                    ...
                    \begin{enumerate}
                        \item \textbf{Phân tích Ray nguồn +4V2\_VSYS:}
                            ...
                            Mô phỏng được thực hiện với dòng tải tiêu thụ cực đại trên thiết kế là $I_{load} = 4.75A$.
