    ...
    \subsection{Thiết kế phần cứng PCB (PCB Hardware Design)}
        ...
        \subsubsection{Thiết kế Mạch nguyên lý (Schematic Design)}
            ...
            \paragraph{Thiết kế Mạch nguồn}
                ...
                \begin{figure}[h]
                    \centering
                    \includegraphics[width=0.9\textwidth]{figures/DATN/sche_powerdcdc.png}
            ...
            \paragraph{Thiết kế Mạch IO Expanders}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.75\textwidth]{figures/DATN/datasheet_ioxpowerrecomendation.png}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.8\textwidth]{figures/sim_ioxdelayvcci.png}
            ...
            \paragraph{Thiết kế Mạch USB/UART Switch}
                ...
                \begin{figure}[h]
                    \centering
                    \includegraphics[width=0.75\textwidth]{figures/DATN/sche_usb-uart_switch.png}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.6\textwidth]{figures/DATN/sche_lcd.png}
            ...
            \paragraph{Thiết kế Mạch I\textsuperscript{2}C Buffer}   
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.6\textwidth]{figures/DATN/sche_i2cbuffer.png}
            ...
            \paragraph{Thiết kế Mạch nút nhấn}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.6\textwidth]{figures/DATN/sche_button.png}
            ...
            \paragraph{Thiết kế Mạch điều khiển quạt DC}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.6\textwidth]{figures/DATN/sche_dcfan.png}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.8\textwidth]{figures/DATN/simu_fandc.png}
                ...
                \begin{figure}[h]
                    \centering
                    \includegraphics[width=0.75\textwidth]{figures/DATN/sche_wan-lan_conn.png}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.9\textwidth]{figures/DATN/sche_wanlte.png}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.9\textwidth]{figures/DATN/sche_wanephy.png}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.9\textwidth]{figures/DATN/sche_lan.png}
