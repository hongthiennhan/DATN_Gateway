    ...
    \subsection{Firmware và Software}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                ...
                \item \textbf{$T_{SPI}$ -- Độ trễ bus Inter-MCU:} Tại xung nhịp 60\,MHz với DMA, worst-case burst ($\approx 2083$ byte) mất $\approx 0{,}37\,\text{ms}$; hệ số sử dụng bus chỉ đạt $3{,}7\%$, xác nhận SPI không phải nút thắt.
            ...
            \begin{longtable}{|p{4.5cm}|p{4cm}|p{5.5cm}|}
                ...
                BLE $\rightarrow$ MQTT & $33\,\text{ms}$--$43\,\text{ms}$ & $T_{network}$ (30 ms) -- chiếm $\approx 80\%$ \\ \hline
            \end{longtable}
            ...
            Ngay cả trong điều kiện worst-case -- tất cả node gửi đồng thời tạo burst $\approx 2083$ byte -- bus SPI chỉ bị chiếm dụng $3{,}7\%$ chu kỳ batch. Thông lượng tối đa lý thuyết của SPI là:
            \[
            ...
            \textbf{Kết luận:} Bus SPI hoàn toàn không phải nút thắt -- hệ số sử dụng trung bình chỉ đạt $0{,}183\%$, worst-case $3{,}7\%$. Nguy cơ suy giảm PDR xuất phát từ Zigbee Listener buffer ($512\,\text{byte}$) bị tràn khi LAN-MCU bận phục vụ ngắt SPI/UART tần suất cao (mỗi $10\,\text{ms}$); đây là điểm cần tối ưu để đạt mục tiêu PDR toàn hệ thống $> 85\%$ dưới tải nặng.
