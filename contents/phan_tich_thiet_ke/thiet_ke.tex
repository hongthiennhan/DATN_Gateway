        ...
        \subsubsection{Phân tích và Mô phỏng Tín hiệu (Signal Integrity Simulation)}
            ...
            \paragraph{Phân tích và Mô phỏng Mạng phân phối nguồn (Power Distribution Network - PDN)}
                \begin{enumerate}
                    ...
                    \newpage
                    Dựa trên thiết kế, mô phỏng tập trung vào các ray nguồn quan trọng ở trạng thái cực đoan với tải lý thuyết cao nhất, bao gồm:
                    \begin{itemize}
                ...
                \item \textbf{Phân tích và Mô phỏng Sụt áp DC (DC IR Drop Analysis):}
                    ...
                    \begin{enumerate}
                        ...
                        \item \textbf{Phân tích Ray nguồn +5V0:}
                            ...
                            \begin{figure}[h]
                                \centering
                                \includegraphics[width=0.6\textwidth]{figures/5v0_sim_voltage_drop.png}
                        ...
                        \item \textbf{Phân tích Ray nguồn +3V3:}
                            ...
                            \begin{figure}[h]
                                \centering
                                \includegraphics[width=0.6\textwidth]{figures/3v3_sim_voltage_drop.png}
                    ...
                    \item \textbf{Phân tích và mô phỏng Mật độ dòng điện:}
                    \begin{itemize}
