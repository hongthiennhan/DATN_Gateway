    ...
    \subsection{Thiết kế phần cứng PCB (PCB Hardware Design)}
        ...
        \subsubsection{Thiết kế Mạch nguyên lý (Schematic Design)}
            ...
            \paragraph{Thiết kế Mạch Module Adapter}
                ...
                Trong thiết kế hiện tại, mạch adapter WAN được triển khai cho module LTE SIM7600G-H-PCIE. Mạch adapter tích hợp các khối chức năng cần thiết để giao tiếp với baseboard, bao gồm cấp và điều khiển nguồn, IO expander, khe SIM và các bus giao tiếp phần cứng. Các thành phần và cấu hình được xây dựng dựa trên \href{https://files.waveshare.com/upload/6/69/SIM7600_Series_PCIE_Hardware_Design_V1.03.pdf}{Tài liệu thiết kế phần cứng của module SIM7600G-H-PCIE}. 

                Adapter WAN LTE được thiết kế với một khe cắm SIM tiêu chuẩn, hỗ trợ thẻ MicroSIM. Các đường tín hiệu của khe cắm được trang bị diode TVS để bảo vệ ESD, kết hợp với các điện trở giảm chấn nối tiếp 22\,$\Omega$ và các tụ điện lọc nhiễu 18\,pF.
