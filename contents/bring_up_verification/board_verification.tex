\section{Quy trình Kiểm tra sản phẩm}
    ...
    \subsection{Kiểm tra Chất lượng Nguồn (Power Integrity Analysis)}
        ...
        \begin{longtable}{|c|c|p{4cm}|>{\centering\arraybackslash}p{1.5cm}|>{\centering\arraybackslash}p{1.5cm}|>{\centering\arraybackslash}p{1.5cm}|c|}
            ...
            1 & \textbf{+12V} & Total Input (Jack DC) & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_green}{\textbf{TBD}} \\ \hline
            2 & \textbf{+5V} & Total Input (USB) & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_green}{\textbf{TBD}} \\ \hline
            3 & \textbf{+3V7\_VBAT} & Total Input (LiPo Battery) & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_green}{\textbf{TBD}} \\ \hline
            ...
            4 & \textbf{+3V3} & Test-point (TP12/13) & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \hline
            5 & \textbf{+3V3\_CTRL} & Test-point (TP18/19) & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \hline
            6 & \textbf{+5V\_CTRL} & Test-point (TP15/17) & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \hline
            ...
            % Rail +3V3
            7 & \multirow{7}{*}{\textbf{+3V3}} & RTC & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            8 & & Power Monitor & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            9 & & ESP32-S3 Master & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            10 & & IO Expanders & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            11 & & WAN Connector & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            12 & & Buttons & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            13 & & I2C Buffer & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \hline

            % Rail +3V3_CTRL
            14 & \multirow{5}{*}{\textbf{+3V3\_CTRL}} & UART Switch & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            15 & & USB Switch & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            16 & & ESP32-S3 Slave & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            17 & & LAN Connectors & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            18 & & MicroSD Card & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \hline

            % Rail +5V_CTRL
            19 & \multirow{2}{*}{\textbf{+5V\_CTRL}} & USART LCD & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \cline{1-1} \cline{3-7}
            20 & & DC FAN & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \hline

            % Rail +3V7_VBAT
            21 & \multirow{1}{*}{\textbf{+3V7\_VBAT}} & Battery Fuel Gauge & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \hline

            % Rail +5V
            22 & \multirow{1}{*}{\textbf{+5V}} & USB to UART & $TBD$ & $TBD$ & $TBD$ & \textcolor{modern_blue}{\textbf{TBD}} \\ \hline
    ...
    Sau khi hoàn tất kiểm tra phần cứng, hệ thống được đưa vào giai đoạn Firmware \& Software Verification nhằm xác nhận bo mạch có thể vận hành ổn định với firmware thực tế, đồng thời kiểm chứng các luồng chức năng cốt lõi của kiến trúc Dual-MCU, gồm WAN-MCU và LAN-MCU giao tiếp qua SPI. Giai đoạn này bổ sung các nhóm kiểm thử mới so với phiên bản trước, bao gồm: hệ thống cấu hình module dựa trên JSON (Module Base Setting), cổng cấu hình Web nhúng (Web Config Portal), BLE Mesh Native Provisioner, các loại server mới (HTTP, CoAP) và loại kết nối Internet mới (Ethernet).
        ...
        \begin{enumerate}
            ...
            \textbf{Phương pháp:} từng node Zigbee, LoRa và BLE gửi dữ liệu liên tục với tốc độ tối đa.
        
            \textbf{Chỉ số đánh giá:} thông lượng thực đo tại LAN-MCU và tại server, tính theo kbps hoặc byte/s; tỷ lệ giao tin thành công PDR (\textit{Packet Delivery Ratio}).
        
            \textbf{Kết quả baseline kỳ vọng:}
            ...
            \begin{longtable}{|p{4.5cm}|p{4.5cm}|p{3.5cm}|}
                ...
                Zigbee & $\approx 80\,kbps$ & $> 95\%$ \\ \hline
                LoRa SF7/125 (P2P) & $\approx 3.5\,kbps$ & $> 99\%$ \\ \hline
                BLE (DLE bật) & $\approx 97.6\,kbps$ & $> 99\%$ \\ \hline
            \end{longtable}
        
            \item \textbf{Kiểm thử đa kênh đồng thời -- Concurrency Test}
        
            \textbf{Phương pháp:} 3 node Zigbee, LoRa và BLE cùng gửi dữ liệu liên tục với tốc độ tối đa.
        
            Thông lượng LAN$\rightarrow$WAN lý thuyết của tổng 3 giao thức:
        
            \[
                R_{total,\ theory}
                = R_{Zigbee} + R_{BLE} + R_{LoRa}
                = 80 + 97.6 + 3.5
                = 181.1\,kbps
            \]
        
            Dữ liệu tích lũy tại LAN-MCU trong một batch interval với $T_{batch} = 50\,ms$:
        
            \begin{longtable}{|p{4cm}|p{3.5cm}|p{5cm}|}
                \caption{Dữ liệu tích lũy trong một chu kỳ batch.}
                ...
                Zigbee & $80\,kbps$ & $80000 / 8 \times 0.050 = 500\,byte$ \\ \hline
                BLE (DLE) & $97.6\,kbps$ & $97600 / 8 \times 0.050 = 610\,byte$ \\ \hline
                LoRa SF7/125 & $3.5\,kbps$ & $3500 / 8 \times 0.050 \approx 22\,byte$ \\ \hline
                \textbf{Tổng} & $\textbf{181.1\,kbps}$ & $\approx 1132\,byte \approx 1.1\,KB$ \\ \hline
            \end{longtable}
        
            Thời gian SPI cần để truyền $1132\,byte$ sang WAN-MCU:
        
            \[
                T_{SPI,\ batch}
                = \frac{1132 \times 8}{40 \times 10^{6}}
                = 0.2246\,ms
            \]
            ...
            \[
                U_{SPI}
                = \frac{T_{SPI,\ batch}}{T_{batch}}
                = \frac{0.2246}{50}
                = 0.4528\%
            \]
        
            Thông lượng SPI tối đa lý thuyết tại $40\,MHz$:
        
            \[
                R_{SPI\ max}
                = 40\,MHz \times \frac{1\,byte}{8\,bit} \times 8
                = 40\,Mbps
                = 5\,MB/s
            \]
        
            \textbf{Kết luận:} SPI không phải nút thắt. Tải thực tế chỉ chiếm khoảng $0.4528\%$ capacity SPI.
        
            Thông lượng LAN$\rightarrow$WAN thực tế kỳ vọng:
        
            \[
                R_{LAN \rightarrow WAN,\ practical}
                \approx (70 \div 85)\% \times 181.1
                \approx 127 \div 154\,kbps
            \]
        
            \textbf{Mục tiêu:} PDR toàn hệ thống $> 85\%$ dưới tải nặng. Suy giảm chủ yếu do Zigbee Listener buffer ($512\,byte$) dễ tràn khi LAN-MCU bận phục vụ SPI cho BLE.
        \end{enumerate}
