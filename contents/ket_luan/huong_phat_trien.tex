...
\section{Hướng phát triển trong tương lai}
    ...
    \begin{itemize}
        ...
        \item \textbf{Xây dựng cơ chế tự phục hồi (Self-healing) dựa trên State Machine:} Hệ thống cần bổ sung các máy trạng thái giám sát chuyên sâu để tự động phát hiện và khôi phục các lỗi logic ngoại vi. Việc tự động hóa quy trình xử lý lỗi này sẽ đảm bảo tính sẵn sàng cao của thiết bị mà không cần sự can thiệp vật lý tại hiện trường.
    \end{itemize}
