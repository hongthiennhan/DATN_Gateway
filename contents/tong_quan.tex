\chapter{Tổng quan Đồ án}
    ...
    \section{Mục tiêu Đồ án}
        ...
        \begin{itemize}
            ...
            \item Hoàn thiện sản phẩm với các chức năng được tích hợp đầy đủ, đảm bảo đáp ứng yêu cầu sử dụng và phát triển trong các kịch bản ứng dụng thực tế.
        \end{itemize}

        Thông qua đồ án, nhóm hướng tới việc áp dụng kiến thức đã học vào bài toán thiết kế – hiện thực một hệ thống kỹ thuật hoàn chỉnh, có tính ứng dụng cao.
    \section{Phạm vi Đồ án}
        Trong khuôn khổ đồ án, nhóm tập trung vào các nội dung sau:
        \begin{itemize}
