\section{Khởi động và Kích hoạt Phần mềm}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.85\textwidth]{figures/hinh_web_final.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.85\textwidth]{figures/hinh_app_final.png}
        \caption{Ứng dụng cấu hình PC -- thiết lập MQTT Broker và Server Config qua cổng USB-C (COM44, 115200 baud).}
