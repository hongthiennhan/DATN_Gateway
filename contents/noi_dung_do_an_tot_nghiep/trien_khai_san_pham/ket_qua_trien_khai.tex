...
\begin{figure}[H]
    ...
    \caption{IoT Gateway kết nối đồng thời với các thiết bị đầu cuối BLE, Zigbee và LoRa P2P trong môi trường thử nghiệm.}
...
\begin{figure}[H]
    ...
    \caption{Dashboard giám sát thiết bị -- quản lý đồng thời 3 giao thức (BLE/Zigbee/LoRa P2P).}
