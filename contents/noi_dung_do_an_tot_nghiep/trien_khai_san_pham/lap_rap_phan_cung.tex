...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth, height=6.5cm, keepaspectratio]{figures/DATN/wan_adapter_lte_real.png}
    \includegraphics[width=0.3\textwidth, height=6.5cm, keepaspectratio]{figures/DATN/wan_adapter_ethernet_real.png}
    \includegraphics[width=0.3\textwidth, height=6.5cm, keepaspectratio]{figures/DATN/lan_adapter_lorawan_real.png}
    \includegraphics[width=0.3\textwidth, height=7cm, keepaspectratio]{figures/DATN/lan_adapter_zigbee_real.png}
    \includegraphics[width=0.3\textwidth, height=7cm, keepaspectratio]{figures/DATN/lan_adapter_rs485_real.png}
