\section{Kịch bản tương tác người dùng}
    ...
    \begin{itemize}
        ...
        \item \textbf{Chỉnh sửa tham số:} Người dùng thác tác trên giao diện dạng biểu mẫu (form) để thiết lập. Hỗ trợ tải lên file JSON preset để provisioning hàng loạt cho nhiều gateway cùng loại stack module.
    ...
    \begin{itemize}
        ...
        \item Trong phiên bản Đồ án Tốt nghiệp, LAN-MCU được cập nhật qua cơ chế \textbf{Wi-Fi NAT}: WAN-MCU khởi tạo điểm truy cập Wi-Fi (NAT mode), LAN-MCU kết nối vào đó và tải gói firmware trực tiếp — cải thiện đáng kể băng thông so với phương thức PPP qua UART của phiên bản nguyên mẫu.
