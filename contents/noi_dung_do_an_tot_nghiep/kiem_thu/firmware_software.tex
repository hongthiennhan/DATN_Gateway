...
Sau khi hoàn tất kiểm tra phần cứng, hệ thống được đưa vào giai đoạn Firmware \& Software Verification nhằm xác nhận bo mạch có thể vận hành ổn định với firmware thực tế, đồng thời kiểm chứng các luồng chức năng cốt lõi của kiến trúc Dual-MCU, gồm WAN-MCU và LAN-MCU giao tiếp qua SPI. Giai đoạn này bổ sung các nhóm kiểm thử mới so với phiên bản trước, bao gồm: hệ thống cấu hình mô-đun dựa trên JSON (Module Base Setting), cổng cấu hình Web nhúng (Web Config Portal), BLE Mesh Native Provisioner, các loại server mới (HTTP, CoAP) và loại kết nối Internet mới (Ethernet).
    ...
    \subsection{Nội dung kiểm thử firmware theo nhóm chức năng}
        ...
        \begin{enumerate}
            ...
            \begin{longtable}{|p{4cm}|p{5.5cm}|p{2.5cm}|}
        ...
        \begin{longtable}{|c|p{0.105\textwidth}|p{0.2\textwidth}|p{0.15\textwidth}|p{0.245\textwidth}|c|}
        ...
        \newpage %add page break to remove extra line at the end of the previous table
        ...
        \begin{longtable}{|c|p{0.15\textwidth}|p{0.25\textwidth}|p{0.3\textwidth}|c|}
        ...
        \begin{longtable}{|c|p{0.15\textwidth}|p{0.275\textwidth}|p{0.275\textwidth}|c|}
        ...
        \begin{longtable}{|c|p{0.12\textwidth}|p{0.18\textwidth}|p{0.15\textwidth}|p{0.25\textwidth}|c|}
        ...
        \begin{longtable}{|c|p{0.16\textwidth}|p{0.12\textwidth}|p{0.22\textwidth}|p{0.2\textwidth}|c|}
            ...
            4 & POST \texttt{/api/config} (Wi-Fi) & Gateway ở STA & POST \texttt{\{"wifi":} \newline\texttt{\{"ssid":"...",} \newline\texttt{"password":} \newline \texttt{"..."\}\}} & Gateway cập nhật Wi-Fi, NVS save & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
            ...
            6 & GET \texttt{/api/lan\_} \newline \texttt{config} & Gateway ở STA, LAN chạy & GET \newline\texttt{/api/lan\_config} & Trả danh sách preset JSON cho BLE / LoRa / Zigbee & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
        
            7 & POST \texttt{/api/lan\_} \newline \texttt{config} (BLE) & Mô-đun BLE đang chạy & POST JSON config BLE qua web & LAN-MCU parse, NVS save, BLE handler restart & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
        ...
        \begin{longtable}{|c|p{0.14\textwidth}|p{0.15\textwidth}|p{0.2\textwidth}|p{0.21\textwidth}|c|}
        ...
        \begin{longtable}{|c|p{0.12\textwidth}|p{0.15\textwidth}|p{0.2\textwidth}|p{0.23\textwidth}|c|}
            ...
            2 & Prefix match -- AT+ \newline CONNECT \newline = & BLE config đã nạp & Gửi \texttt{CFBL:0:}\newline\texttt{AT+CONNECT=}\newline\texttt{AABBCCDDEE} & Firmware ghép command đúng, gửi UART đến mô-đun & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
        ...
        \begin{longtable}{|c|p{0.12\textwidth}|p{0.15\textwidth}|p{0.2\textwidth}|p{0.23\textwidth}|c|}
            ...
            6 & Enable Notify & Đã discover, có characteristic notify & Gửi \texttt{CFBL:0:}\newline\texttt{AT+NOTIFY=0,}\newline\texttt{<handle>,1} & Notify enable OK, mô-đun gửi +NOTIFY khi có data & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
            ...
            8 & Disconnect & Đang connected & Gửi \texttt{CFBL:0:}\newline\texttt{AT+DISCONNECT=0} & \texttt{+DISCONNECTED:0}, mô-đun sẵn sàng scan lại & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
        ...
        \begin{longtable}{|c|p{0.13\textwidth}|p{0.12\textwidth}|p{0.225\textwidth}|p{0.225\textwidth}|c|}
        ...
        \begin{longtable}{|c|p{0.12\textwidth}|p{0.15\textwidth}|p{0.2\textwidth}|p{0.23\textwidth}|c|}
            ...
            2 & Tham số RF (SF, BW, CR) & JSON config nạp & Nhập tham số trên App và ghi lên gateway & Config lưu NVS và áp dụng trên mô-đun & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
        ...
        \begin{longtable}{|c|p{0.12\textwidth}|p{0.19\textwidth}|p{0.13\textwidth}|p{0.25\textwidth}|c|}
            ...
            7 & Internet -- Ethernet & Cắm cáp, DHCP & Ethernet mô-đun & Lấy IP, online ổn định & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
            ...
            14 & BLE AT Command & Scan/Connect\newline/Write & BLE mô-đun & Mô-đun phản hồi đúng, response forward về server & \textcolor{modern_blue}{\textbf{Passed}} \\ \hline
        ...
        \begin{longtable}{|c|p{0.15\textwidth}|p{0.175\textwidth}|p{0.2\textwidth}|c|}
