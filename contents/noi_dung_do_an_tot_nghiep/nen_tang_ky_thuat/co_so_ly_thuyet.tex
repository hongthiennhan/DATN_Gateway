\section{Cơ sở lý thuyết}
    ...
    \subsection{Phân tích các sản phẩm trên thị trường}
        ...
        \subsubsection{Các mô hình triển khai gateway}
            ...
            \paragraph{Thiết bị đầu cuối kiêm chức năng gateway (mô hình phân tán)}
            ...
            \paragraph{Nhiều thiết bị đầu cuối kết nối đến một gateway trung tâm (mô hình tập trung)}
