\section{Phân tích sơ bộ}
    \subsection{Đặc tả sản phẩm}\label{sec:phan_tich_chung}
        Dựa trên mục tiêu và phạm vi đã xác định trong \autoref{sec:y_tuong}, phần này sẽ đi sâu vào việc phân tích yêu cầu kỹ thuật chi tiết cho hệ thống IoT gateway dạng mô-đun có khả năng cấu hình. Mục tiêu cốt lõi là thiết kế một IoT Gateway giải quyết bài toán linh hoạt và khả cấu hình nhằm tối ưu chi phí và thời gian triển khai hệ thống cho đa dạng các nhu cầu sử dụng.
