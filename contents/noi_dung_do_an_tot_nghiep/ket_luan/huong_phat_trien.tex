...
\section{Hướng phát triển trong tương lai}
    ...
    %     \begin{itemize}
    %         \item Đa dạng hóa kênh kết nối Internet: Hiện tại hệ thống chưa hỗ trợ Ethernet và NB-IoT. Cần phát triển driver cho mô-đun Ethernet (như W5500 hoặc EMAC tích hợp) và mô-đun NB-IoT để tăng tính dự phòng đường truyền khi Wi-Fi hoặc LTE gặp sự cố.
    ...
    %         \item Xây dựng cơ chế xử lý lỗi (Error Handling) toàn diện: Hiện tại cơ chế xử lý lỗi còn sơ sài. Cần bổ sung các trình phục vụ ngắt và giám sát trạng thái (State Machine) để tự động phát hiện và khôi phục (Self-healing) khi xảy ra các lỗi như: mất kết nối mô-đun, treo bus SPI/I2C, hoặc tràn bộ nhớ đệm.
    %     \end{itemize}
    % \end{itemize}
