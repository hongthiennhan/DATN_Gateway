            ...
            \subsection{Thiết kế High-Speed PCB}
                ...
                \subsubsection{Tính toàn vẹn tín hiệu (Signal Integrity) và đường hồi dòng (Return Path)}
                    \paragraph{Signal Integrity (SI)}
                        Signal Integrity là mức độ mà tín hiệu đến đầu nhận vẫn giữ được biên độ, dạng xung và thời điểm chuyển mức như dự kiến. Mất toàn vẹn tín hiệu thể hiện qua méo dạng dạng sóng, overshoot/undershoot, rung (ringing), jitter và gây ra vấn đề lỗi dữ liệu.
                        ...
                        \begin{figure}[H]
                            \centering
                            \includegraphics[width=0.45\textwidth]{figures/lythuyet_ringing.png}
                    ...
                    \paragraph{Return path và vai trò của mặt phẳng tham chiếu}
                        ...
                        \begin{figure}[H]
                            \centering
                            \includegraphics[width=0.45\textwidth]{figures/lythuyet_highspeedlayout.png}
                ...
                \subsubsection{Kiểm soát trở kháng}
                    ...
                    \paragraph{Các yếu tố quyết định trở kháng của đường dây}
                        ...
                        \begin{figure}[H]
                            \centering
                            \includegraphics[width=0.45\textwidth]{figures/microstriplines-side-views.png}
                    ...
                    \paragraph{Lý do phải kiểm soát và khớp trở kháng}
                        ...
                        Các mục tiêu chính của việc kiểm soát và khớp trở kháng bao gồm:
                        \begin{itemize}
                            \item Giảm thiểu phản xạ tín hiệu: Khi \(Z_0\) của đường truyền được duy trì ổn định và phù hợp với trở kháng của nguồn phát và tải, hệ số phản xạ \(\Gamma\) tiệm cận về không. Nhờ đó, các hiện tượng như overshoot, ringing và méo dạng tín hiệu được hạn chế, giúp cải thiện biên độ tín hiệu hiệu dụng và chất lượng eye diagram.
                ...
                \subsubsection{Quy tắc bố trí để giảm nhiễu, crosstalk và cải thiện EMI}
                    \paragraph{Giảm nhiễu xuyên kênh (crosstalk)}
                        Nhiễu xuyên kênh là hiện tượng nhiễu không mong muốn phát sinh do sự ghép điện dung và ghép cảm ứng giữa các đường tín hiệu đặt gần nhau trên PCB. Trong các hệ thống tốc độ cao, crosstalk có thể làm méo dạng xung, gây jitter, làm thu hẹp eye diagram và trong trường hợp nghiêm trọng có thể dẫn đến lỗi dữ liệu trên các đường tín hiệu lân cận. Mức độ crosstalk phụ thuộc vào khoảng cách giữa các trace, chiều dài đoạn chạy song song, cấu trúc stack-up và chất lượng của đường trở về dòng tín hiệu. Một số biện pháp thường được áp dụng để hạn chế crosstalk bao gồm:
                        \begin{itemize}
                        ...
                        \begin{figure}[H]
                            \centering
                            \includegraphics[width=0.5\textwidth]{figures/lythuyet_crosstalk.jpg}
                    ...
                    \paragraph{Cải thiện khả năng EMI/EMC}
                        ...
                        \begin{itemize}
                            \item Giảm diện tích vòng dòng bằng cách định tuyến tín hiệu ngay trên hoặc sát mặt phẳng tham chiếu liên tục, đồng thời bổ sung via mass khi tín hiệu phải chuyển lớp để duy trì đường trở về liên tục.
