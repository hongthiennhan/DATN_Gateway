...
\fancypagestyle{plain}{
    ...
    \fancyfoot[C]{
        \\[-20pt]
        {\color{BKblue}\rule{\textwidth}{1pt}} % Đường kẻ màu xanh
        \thepage
    }
...
\fancyhead[L]{
    {\hspace*{0.4cm}}{\color{BKblue}\fontsize{12pt}{30pt}\textbf{\leftmark}}\\[-20pt]
    {\hspace*{-0.5cm}}\includegraphics[height=1.5cm]{figures/logo/logo_bk.png}\\[-25pt]
    {\hspace*{0.5cm}}\rightmark\\[-5pt]
    {\color{BKblue}\rule{\textwidth}{5pt}}\\[-12pt]
