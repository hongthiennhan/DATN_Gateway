...
\usepackage{lastpage}
\newcommand{\CurrentLastPageRef}{\pageref{LastPage}}
...
\usepackage{pdfpages}
\makeatletter
\define@key{Gin}{artifact}[]{} % Định nghĩa khóa artifact trống để không bị báo lỗi
\makeatother
...
\fancypagestyle{plain}{
    ...
    \fancyfoot[R]{
        % \\[-10pt]
        {\rule{\textwidth}{1pt}}\\
        {\fontsize{10pt}{15pt}\textbf{Trang \thepage}}
    }
    \fancyfoot[L]{
        % \\[-10pt]
        {\rule{\textwidth}{1pt}}\\
...
\fancyhead[L]{
    \\[-20pt]
    {\hspace*{1.25cm}}{\fontsize{10pt}{15pt}\textbf{\orgName}}\\[-15pt]
    {\hspace*{0cm}}\includegraphics[height=1cm]{figures/logo/logo_bk.png}\\[-17pt]
    {\hspace*{1.25cm}}{\fontsize{10pt}{15pt}\textbf{Khoa Khoa học \& Kỹ thuật Máy tính}}\\[-7pt]
